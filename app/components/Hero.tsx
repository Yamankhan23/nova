...
export default function Hero() {
    return (
        <section
            id="hero"
            className="relative min-h-screen flex items-center justify-center px-6 pt-28 bg-black overflow-visible"
        >
            {/* HERO CONTENT */}
            <div className="relative z-10 max-w-4xl text-center fade-up mx-auto">
                <h1 className="text-5xl md:text-7xl font-extrabold leading-tight gradient-text">
