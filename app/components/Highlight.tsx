        ...
        >
            ...
            <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-16 items-center">
                ...
                <div className="relative flex items-center justify-center">
                    <div className="w-[420px] h-[420px] rounded-full bg-gradient-to-br from-purple-600 via-pink-500 to-yellow-400 blur-[90px] opacity-70 animate-pulse absolute" />

                    <div className="relative w-[380px] h-[380px] rounded-3xl bg-white/5 border border-white/10 backdrop-blur-xl shadow-2xl shadow-purple-500/20 flex items-center justify-center">
                        <h3 className="text-3xl font-bold gradient-text text-center px-8 leading-snug">
                ...
                <div className="fade-up">
                    ...
                    <a
                        href="#contact"
                        className="mt-10 inline-block px-8 py-4 rounded-full bg-gradient-to-r from-purple-600 to-pink-500 text-white font-semibold shadow-lg shadow-purple-600/40 hover:scale-105 transition-transform"
                    >
                        Get Started
                    </a>
                </div>
